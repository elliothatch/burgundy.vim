...
" hi CursorLineNr guifg=#f0bf69 guibg=#30111d guisp=#30111d gui=BOLD ctermfg=NONE ctermbg=236 cterm=BOLD
...
hi Folded guifg=#f2c9db guibg=#4a1027 guisp=#4a1027 gui=italic ctermfg=224 ctermbg=237 cterm=NONE
hi FoldColumn guifg=#f2c9db guibg=#4a1027 guisp=#4a1027 gui=italic ctermfg=224 ctermbg=237 cterm=NONE
...
hi DiffChange guifg=#1a0a16 guibg=#cf9023 guisp=#401a36 gui=NONE ctermfg=234 ctermbg=172 cterm=NONE
hi DiffAdd guifg=#8bf792 guibg=#0a4a19 guisp=#0a4a19 gui=NONE ctermfg=120 ctermbg=22 cterm=NONE
hi DiffText guifg=#1a0a16 guibg=#f0bf69 guisp=#782963 gui=NONE ctermfg=234 ctermbg=215 cterm=NONE
hi DiffDelete guifg=#630512 guibg=#630512 guisp=#630512 gui=NONE ctermfg=52 ctermbg=52 cterm=NONE

hi Visual guifg=#192224 guibg=#F9F9FF guisp=#F9F9FF gui=NONE ctermfg=235 ctermbg=189 cterm=NONE

hi StatusLine guifg=#f2c9db guibg=#611835 guisp=#611835 gui=NONE ctermfg=224 ctermbg=53 cterm=NONE
hi StatusLineNC guifg=#f2c9db guibg=#4a1027 guisp=#4a1027 gui=NONE ctermfg=224 ctermbg=237 cterm=NONE
...
hi VertSplit guifg=#2e0b1a guibg=#4a1027 guisp=#4a1027 gui=bold ctermfg=234 ctermbg=237 cterm=bold
...
hi colorcolumn guifg=NONE guibg=#2b0715 guisp=#2b0715 gui=NONE ctermfg=NONE ctermbg=235 cterm=NONE
